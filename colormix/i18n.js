...
(function (root, factory) {
  ...
  var ja = {
    ...
    "addon.title": "追い足し（オプション）",
    "addon.hint":
      "合計量に対して 5〜10% ほどの1剤を、あとから足す塗り方に対応します。使わないときはOFFのままでOK。",
    "addon.toggle": "追い足しを使う",
    "addon.custom": "その他の％",
    "addon.aria.group": "追い足しの割合",
    "addon.aria.input": "追い足しの割合（％）",
    "addon.aria.minus": "1% 減らす",
    "addon.aria.plus": "1% 増やす",
    "addon.preview": "合計 {total}g に対して **＋{g}g** の1剤を追い足します",
    ...
    "result.addon": "追い足し1剤",
    "result.addonSub": "合計量の {pct}%",
    "result.addonBreak": "追い足しの内訳 {list}",
    "result.grand": "総量（追い足し込み）",
    "step.label": "計量の単位",
    "step.1": "1g刻み",
    "step.0.1": "0.1g刻み",
    ...
    "how.note3":
      "**追い足し**をONにすると、合計量の 5〜10% 分の1剤を追加で計算します（例：合計 120g で 5% なら ＋6g）。追い足し分も1剤の割合どおりに分けます。",
    ...
    "reg.q2.hint": "@ の後のIDを入力してください。プロフィールのURLを貼ってもOK。",
  ...
  var yue = {
    ...
    "label.grams": "份量",
    "addon.title": "追加染膏（選用）",
    "addon.hint": "對應在總量之外，再額外加入約 5〜10% 染膏的塗法。不需要時保持關閉即可。",
    "addon.toggle": "使用追加染膏",
    "addon.custom": "其他百分比",
    "addon.aria.group": "追加染膏的百分比",
    "addon.aria.input": "追加染膏的百分比（%）",
    "addon.aria.minus": "減 1%",
    "addon.aria.plus": "加 1%",
    "addon.preview": "以總量 {total}g 計算，額外加入 **＋{g}g** 染膏",
    "result.title": "配方份量",
    ...
    "result.addon": "追加染膏",
    "result.addonSub": "總量的 {pct}%",
    "result.addonBreak": "追加染膏分配 {list}",
    "result.grand": "總量（連追加染膏）",
    "step.label": "秤量精度",
    "step.1": "1g 為單位",
    "step.0.1": "0.1g 為單位",
    "action.copy": "📋 複製",
    ...
    "how.note3": "開啟**追加染膏**後，系統會按總量的 5〜10% 計算額外的染膏用量（例：總量 120g、5% 即 ＋6g）。追加的份量同樣會按染膏比例分配。",
    "footer.by": "提供",
    "footer.lead": "產品查詢及訂購",
    "footer.site": "官方網站",
    "footer.instagram": "Instagram",
