...
ヘッダーとフッターに DRIVE BLUE HONG KONG のロゴを表示しています。

- **ロゴ画像 (`logo.png`) は加工していません。** もらった原本から余白を
  取り除いただけで、絵柄のピクセルは1つも変えていません。
- 紫のヘッダーとダークモードでも original のまま見えるよう、**白い台紙**の
  上に載せています（ロゴ自体を白抜きに作り替えることはしていません）。
