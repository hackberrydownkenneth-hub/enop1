@echo off
rem エノップ 経営管理(PL・BS・経営指標・投資回収)を起動する。
...
if "%FINANCE_PORT%"=="" set "FINANCE_PORT=5001"
echo.
echo   Enop management -^> http://127.0.0.1:%FINANCE_PORT%
echo   Press Ctrl+C in this window to stop.
echo.
start "" "http://127.0.0.1:%FINANCE_PORT%"
